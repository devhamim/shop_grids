                    ...
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('unit.update',['id'=>$unit->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="exampleInputuname3" name="code" value="{{$unit->code}}" placeholder="Unit code">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea type="email" class="form-control" id="exampleInputEmail3" name="description" placeholder="Unit Description">{{$unit->description}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="radio" name="status" id="published" value="1" {{$unit->status==1?'checked':''}}> <label for="published" class="me-2">Published</label>
                                <input type="radio" name="status" id="unpublished" value="2" {{$unit->status==2?'checked':''}}> <label for="unpublished" {{$unit->status==2?'checked':''}}>Unpublished</label>
