                    ...
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('category.update',['id'=>$category->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="exampleInputuname3" value="{{$category->name}}" name="name" placeholder="Category Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea type="email" class="form-control" id="exampleInputEmail3" name="description" placeholder="Category Description">{{$category->description}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($category->image)}}" class="mt-2" height="70px" width="70px" alt="">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="radio" name="status" id="published" value="1" {{$category->status==1?'checked':''}}> <label for="published" class="me-2">Published</label>
                                <input type="radio" name="status" id="unpublished" value="2" {{$category->status==2?'checked':''}}> <label for="unpublished">Unpublished</label>
                            </div>
                        </div>
