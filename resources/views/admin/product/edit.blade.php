                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('product.update',['id'=>$product->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="code" name="code" value="{{$product->code}}" placeholder="Product Code" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="stock_amount" value="{{$product->stock_amount}}" name="stock_amount" placeholder="Product Stock Amount" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="number" min="0" class="form-control" value="{{$product->regular_price}}" id="regular_price" name="regular_price" placeholder="Product Regular Price" required>
                                    <input type="number" min="0" class="form-control" value="{{$product->selling_price}}" id="selling_price" name="selling_price" placeholder="Product Selling Price" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" id="short_description" name="short_description" placeholder="Short Description" required>{{$product->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="long_description" class="col-sm-3 control-label">Long Description <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control summernote" id="long_description" name="long_description" placeholder="Long Description" required>{{$product->long_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($product->image)}}" height="100" width="120" alt="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @foreach($product->otherImages as $otherImage)
                                    <img src="{{asset($otherImage->image)}}" height="100" width="120" alt="">
                                @endforeach
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="radio" name="status" {{$product->status = 1 ? 'checked':''}} id="published" value="1" checked > <label for="published" class="me-2">Published</label>
                                <input type="radio" name="status" {{$product->status = 2 ? 'checked':''}} id="unpublished" value="2" > <label for="unpublished">Unpublished</label>
                            </div>
                        </div>
                        <div class="form-group row m-b-0">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="btn btn-success waves-effect waves-light text-white">Update New Product</button>
                            </div>
                        </div>
                    </form>
                </div>
