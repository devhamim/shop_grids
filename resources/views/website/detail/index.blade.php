...
{{--                            <main id="gallery">--}}
{{--                                <div class="main-img">--}}
{{--                                    <img src="{{asset($product->image)}}" height="500" id="current" alt="#">--}}
{{--                                </div>--}}
{{--                                <div class="images">--}}

{{--                                    @foreach($product->otherImages as $otherImage)--}}
{{--                                    <img src="{{asset($otherImage->image)}}" height="130" class="img" alt="#">--}}
{{--                                    @endforeach--}}
{{--                                </div>--}}
{{--                            </main>--}}
                            <div class="xzoom-container">
                                ...
                                <div class="xzoom-thumbs">
                                    @foreach($product->otherImages as $otherImage)
                                    <a href="{{asset($otherImage->image)}}"><img class="xzoom-gallery" width="80" src="{{asset($otherImage->image)}}"  xpreview="{{asset($otherImage->image)}}" title="{{$product->name}}"></a>
                                    @endforeach
                                </div>
                            </div>
{{--                        </div>--}}
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Product Sub Category:<a href="javascript:void(0)">
