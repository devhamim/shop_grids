...
{{--                                        @dd(ShoppingCart::all())--}}
                                        ...
                                        <li>
                                            <a onclick="return confirm('Are you sure to delete this')" href="{{route('remove-cart-product',['id'=>$product->__raw_id])}}" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset($product->image)}}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">
                                                        {{$product->name}}</a></h4>
                                                <p class="quantity">{{$product->qty}}x - <span class="amount">Tk.{{$product->price}}</span></p>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">Tk.{{ShoppingCart::total()}}</span>
                                        </div>
                                        <div class="button">
